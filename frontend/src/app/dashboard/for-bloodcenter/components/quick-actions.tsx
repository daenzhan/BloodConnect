...
const actions = [
    {
        ...
        path: "/dashboard/for-bloodcenter/requests",
    ...
    },
    {
        ...
        path: "/dashboard/for-bloodcenter/reserve",
    ...
    },
    {
        ...
        path: "/dashboard/for-bloodcenter/donations",
    ...
    },
    {
        ...
        path: "/dashboard/for-bloodcenter/statistics",
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {actions.map((action) => {
                ...
                const href = userId ? `${action.path}?userId=${userId}` : action.path
                return (
